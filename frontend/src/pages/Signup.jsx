...
export default function Signup() {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md flex flex-col items-center mt-6 border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 p-8 shadow">
